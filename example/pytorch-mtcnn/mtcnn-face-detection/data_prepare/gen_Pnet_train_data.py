...
from utils.mtcnn_utils import IoU
...
def gen_pnet_data():
    ...
    if not os.path.exists(anno_store_dir):
        os.mkdir(anno_store_dir)

    post_save_file = os.path.join(anno_store_dir, "pos_12.txt")
    neg_save_file = os.path.join(anno_store_dir, "neg_12.txt")
    part_save_file = os.path.join(anno_store_dir, "part_12.txt")
    ...
    for annotation in annotations:
        ...
        im_path = os.path.join(prefix_path, annotation[0])
    ...
    f2.close()
    f3.close()
    np_path = os.path.join(data_dir, "12")
